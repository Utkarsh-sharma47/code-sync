...
const ProblemPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-sky-500/30 relative overflow-hidden">
      
      <Navbar />

      {/* --- Background Ambient Glow Effects --- */}
      <div className="absolute top-0 left-[-10%] w-[40rem] h-[40rem] bg-sky-600/10 rounded-full blur-[120px] pointer-events-none animate-pulse-slow" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40rem] h-[40rem] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none animate-pulse-slow delay-700" />
          ...
          <AnimatePresence mode='popLayout'>
            {filteredProblems.map((problem) => (
                ...
                <Link to={`/problem/${problem.id}`} className="block">
                    {/* Card Container - Updated hover to Sky Blue for contrast */}
                    <div className="relative overflow-hidden bg-slate-900/40 backdrop-blur-md border border-white/10 rounded-xl p-5 md:p-6 transition-all duration-300 group-hover:border-sky-500/40 group-hover:shadow-[0_0_20px_rgba(14,165,233,0.15)]">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-start gap-4">
                            {/* Icon Box */}
                            <div className="hidden sm:flex items-center justify-center w-12 h-12 rounded-lg bg-white/5 text-slate-400 group-hover:bg-sky-500/20 group-hover:text-sky-400 transition-colors duration-300 flex-shrink-0">
                            ...
                            <div className="min-w-0">
                                <h3 className="text-lg md:text-xl font-bold text-white group-hover:text-sky-400 transition-colors duration-300 mb-2 truncate">
                                    {problem.title}
                                </h3>
                        ...
                        <div className="flex items-center justify-start md:justify-end mt-2 md:mt-0">
                            <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 text-slate-300 border border-white/10 group-hover:bg-sky-600 group-hover:text-white group-hover:border-sky-500 transition-all duration-300 text-sm font-semibold tracking-wide w-full md:w-auto justify-center md:justify-start shadow-lg shadow-transparent group-hover:shadow-sky-500/20">
                                Solve Problem
