...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-slate-930/50 backdrop-blur-xl border-b border-white/5 transition-all duration-300">
      <div className="container mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div className="flex-shrink-0">
            <Link to="/" className="flex items-center gap-3 group">
                ...
                {/* Logo Icon Container - Always Glowing, Intensifies on Hover */}
                <div className="
        ...
        <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3">
                <SignedIn>
                    <div className="p-0.5 rounded-full hover:from-blue-500/50 hover:to-pink-500/50 transition-all duration-300">
                        <UserButton 
                            appearance={{
                                elements: {
                                    avatarBox: "w-9 h-9 border-2 border-slate-900"
                                }
                            }}
                        />
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden border-b border-white/5 bg-slate-950/95 backdrop-blur-2xl overflow-hidden"
          >
